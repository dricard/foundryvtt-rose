export class OsePartyXP extends FormApplication {
     ...
     */
    get title() {
        return game.i18n.localize("ROSE.dialog.xp.deal");
    }
     ...
     */
    getData() {
        const actors = this.object.entities.filter(e => e.data.type === "character" && e.data.flags.rose && e.data.flags.rose.party === true);
        let data = {
            actors: actors,
            data: this.object,
            config: CONFIG.ROSE,
